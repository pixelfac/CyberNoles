...
@Autonomous(name="Autonomous_RedBuildingZone", group="Linear Opmode")
public class RedBuildingZone {
    ...
    public void runOpMode() {
        ...
        //flip up clamps
        strafeLeft(5000); //go to loading zone
        forward(2000); //move towards blocks
        //analyze and pick up correct skystone
        backward(2000); //return to wall
        strafeRight(5000); //go back to foundation
        //deposit block
        strafeLeft(2500); //park onto midzone
    }
